...
<head>
    ...
    <title>Мои объявления - HelpPaw</title>
...
<body>
    ...
    <main>
        ...
        <div class="pet-list">
            <?php if (empty($ads)): ?>
                <p class="no-pets">У вас пока нет объявлений</p>
            <?php else: ?>
                    ...
                    <div class="pet-card">
                        ...
                        <div class="pet-card-right">
                            <div class="pet-header">
                                ...
                                <a href="edit_ad.php?id=<?= $ad['id'] ?>" class="pet-edit-link">Редактировать</a>
                            </div>
                            <div class="pet-details">
                                ...
                                <p><strong>Дата:</strong> <?= date('d.m.Y', strtotime($ad['created_at'])) ?></p>
                                <p><strong>Статус модерации:</strong> <?= $ad['is_approved'] ? 'Одобрено' : 'На проверке' ?></p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
